...
class Server:
    ...
    def animate2(self, i):
        ...
        fig2.set_xlabel('pozycja w osi x')
        fig2.set_ylabel('pozycja w osi y')
        #c1 = plt.Circle((200,200),10,color ='g', fill=False)
        #c2 = plt.Circle((100,300),10,color ='g', fill=False)
        #fig2.add_patch(c1)
        #fig2.add_patch(c2)
